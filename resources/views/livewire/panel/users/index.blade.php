...
<x-layouts.app :title="__('users.Users')">
    ...
    ">
        ...
        <div x-show="loading" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0"
            ...
            style="display: none;">
            <div class="bg-white dark:bg-zinc-800 rounded-lg p-6 shadow-xl border dark:border-zinc-700">
        ...
        <div x-show="showWelcome" class="bg-gradient-to-r from-blue-500 to-purple-600 dark:from-blue-600 dark:to-purple-700 rounded-lg p-6 mb-6 text-white shadow-lg"
            ...
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-blue-100 dark:text-purple-100 mb-4">
                        Gerencie usuários, defina permissões e monitore atividades do sistema.
                    </p>
                    <div class="flex gap-2 flex-wrap">
                        <span class="px-3 py-1 bg-white bg-opacity-20 dark:bg-white dark:bg-opacity-25 rounded-full text-sm text-white dark:text-gray-800">Livewire</span>
                        <span class="px-3 py-1 bg-white bg-opacity-20 dark:bg-white dark:bg-opacity-25 rounded-full text-sm text-white dark:text-gray-800">Volt</span>
                        <span class="px-3 py-1 bg-white bg-opacity-20 dark:bg-white dark:bg-opacity-25 rounded-full text-sm text-white dark:text-gray-800">Alpine.js</span>
                        <span class="px-3 py-1 bg-white bg-opacity-20 dark:bg-white dark:bg-opacity-25 rounded-full text-sm text-white dark:text-gray-800">Tailwind</span>
                    </div>
                </div>
                ...
                <button @click="showWelcome = false; localStorage.setItem('welcomeDismissed', 'true')"
                    class="text-white hover:text-gray-200 dark:hover:text-gray-300 transition-colors flex-shrink-0 ml-4">
        ...
        <div class="fixed bottom-6 right-6 lg:hidden">
            <button wire:click="createUser"
                class="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white rounded-full p-4 shadow-lg hover:shadow-xl dark:shadow-2xl transition-all duration-200 flex items-center justify-center">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
